...
class AppelTMDB:
    ...
    def obtenir_info_film(self, film_id, language = 'fr-FR'):
    ...
    def rechercher_film(self, query, language = None, primary_release_year = None, page = None, region = None, year = None):
        payload = {'query': query,
                    'language': language,
